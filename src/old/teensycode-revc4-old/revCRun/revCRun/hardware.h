...
#define NUM_C 1//number of channesl per board
...
const int boardMap[NUM_B] = {0};//{3,4,5,6};
...
void spiInit() {
  ...
  SPI_MASTER->setCTAR(CTAR_MODE0, 16, SPI_MODE0, LSB_FIRST, SPI_CLOCK_DIV8);
...
uint16_t LTC1863ReadSlow(uint8_t address) {
  ...
  selectDAC(); //toggle CS line to initialize the conversion
